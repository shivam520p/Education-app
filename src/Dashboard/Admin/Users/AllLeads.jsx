...
const AllLeads = () => {
  const { statusOfLeads,allLeads, getAllLeadsFromUser, popUp, setPopUp, deleteLeads } =
                      ...
                      <td className="py-2 md:py-3 px-2 md:px-4 text-sm md:text-base text-center">
                        ...
                        <td className="hidden md:table-cell py-2 md:py-3 px-2 md:px-4 text-sm md:text-base text-center text-gray-400">
                          <select onChange={(e)=>{
                            ...
                            statusOfLeads(e.target.value,leads._id)}} className={` text-xl p-3 cursor-pointer`} name="" id="">
                            <option className={`${leads.status==='Complete'&&'text-green-300'} ${leads.status==='Rejected'&&'text-green-300'} ${leads.status==='Pending' && 'text-gray-300'} `}>{leads.status}</option>
                            <option className='text-green-300 p-4' value="Complete">Complete</option>
                            <option className='text-red-300 p-4' value="Rejected">Rejected</option>
                            </select>
                          </td>
