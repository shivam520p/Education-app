...
const WriteContent = () => {
  const { quoteForm, quoteHandleChange, quoteSubmit } =
  ...
  return (
    <>
      ...
      <div className="p-5">
        ...
        <form className="space-y-4" onSubmit={quoteSubmit}>
          <div>
            ...
            <input
              ...
              className="w-1/2 px-4 py-3 border rounded-lg outline-blue-500 placeholder:text-lg"
              required
            />
          </div>
